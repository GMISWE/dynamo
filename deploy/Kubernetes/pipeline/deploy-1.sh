...
DOCKER_DEFAULT_PLATFORM=linux/amd64 DYNAMO_IMAGE=dynamo:latest-vllm-dev dynamo build --containerize $DYNAMO_IDENTIFIER
...
imagePullSecrets:
- name: artifact-registry-key-secret

natsAddr: nats://172.30.1.126:4222
etcdAddr: 172.30.1.126:2379
EOF
